    ...
    try {
        ...
        callAgent.on('incomingCall', async (args) => {
            try {
                ...
                acceptCallButton.classList.remove("disable");
                startCallButton.disabled = true;
                startCallButton.classList.add("disable");
        ...
        startCallButton.classList.remove("disable");
        initializeCallAgentButton.disabled = true;
        initializeCallAgentButton.classList.add("disable");
    } catch(error) {
        console.error(error);
    }
}
    ...
    try {
        ...
        call.on('stateChanged', async () => {
            ...
            if(call.state === 'Connected') {
                ...
                connectedLabel.classList.remove("disable");
                acceptCallButton.classList.add("disable");
                startCallButton.classList.add("disable");
                hangUpCallButton.classList.remove("disable");
                startVideoButton.classList.remove("disable");
                stopVideoButton.classList.remove("disable");
                remoteVideosGallery.classList.remove("disable");
                ...
                connectedLabel.classList.add("disable");
                startCallButton.classList.remove("disable");
                hangUpCallButton.classList.add("disable");
                startVideoButton.classList.add("disable");
                stopVideoButton.classList.add("disable");
...
removeLocalVideoStream = async() => {
    try {
        ...
        localVideoContainer.classList.add("disable");
    } catch (error) {
        console.error(error);
    } 
}
